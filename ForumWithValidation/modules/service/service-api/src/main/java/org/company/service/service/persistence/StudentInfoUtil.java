...
/**
 * The persistence utility for the student info service. This utility wraps <code>org.company.service.service.persistence.impl.StudentInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StudentInfoUtil {
	 ...
	 */
	public static Map<Serializable, StudentInfo> fetchByPrimaryKeys(
	 ...
	 */
	public static StudentInfo update(
		StudentInfo studentInfo, ServiceContext serviceContext) {
	 ...
	 */
	public static StudentInfo create(long studentId) {
	 ...
	 */
	public static StudentInfo remove(long studentId)
		throws org.company.service.exception.NoSuchStudentInfoException {
	 ...
	 * @throws NoSuchStudentInfoException if a student info with the primary key could not be found
	 */
	public static StudentInfo findByPrimaryKey(long studentId)
		throws org.company.service.exception.NoSuchStudentInfoException {
	 ...
	 */
	public static StudentInfo fetchByPrimaryKey(long studentId) {
	...
	private static ServiceTracker
		<StudentInfoPersistence, StudentInfoPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StudentInfoPersistence.class);

		ServiceTracker<StudentInfoPersistence, StudentInfoPersistence>
			serviceTracker =
				new ServiceTracker
					<StudentInfoPersistence, StudentInfoPersistence>(
						bundle.getBundleContext(), StudentInfoPersistence.class,
						null);
